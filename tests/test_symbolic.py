...
from derive.regression.core import (
...
class TestImport:
    ...
    def test_import_from_derive(self):
        """Test that FindFormula can be imported from derive."""
        from derive import FindFormula as FF
        assert FF is not None
        assert callable(FF)

    def test_import_from_regression(self):
        """Test direct import from regression module."""
        from derive.regression import FindFormula as FF
        assert FF is not None
        assert callable(FF)
