...
from derive.core.math_api import Symbol
from derive.calculus import D, VariationalDerivative
from derive.discretization import Discretize, ToStencil, StencilCodeGen
from derive.utils import Pipe
...
class TestDiscretize:
    ...
    def test_nested_expression(self):
        ...
        from derive.core.math_api import sin
        # sin(df/dx)
        expr = sin(D(f, x))
        result = Discretize(expr, {x: ([x - h, x, x + h], h)})
